...
export default function AuthLayout({ children }) {
  return <div className="auth-shell">
    <aside className="experience">
      ...
      <footer className="experience-footer"><span>NEXOADMIN / PLATAFORMA DE EVENTOS</span><span>HECHO PARA CONECTAR <ArrowUpRight size={12}/></span></footer>
    </aside>
    <section className="form-side"><div className="form-top"><span><Fingerprint size={16}/> ACCESO A LA PLATAFORMA</span><span className="private-badge"><span/> Espacio privado</span></div><div className="mobile-brand"><Brand/></div><div className="form-content">{children}</div><footer className="form-footer"><ShieldCheck size={15}/><span>Tu operación empieza con un acceso seguro.</span></footer></section>
  </div>;
}
