...
const ATLAS_URI = 'mongodb://Cris:1234@ac-wp7enmg-shard-00-00.gwcqbvw.mongodb.net:27017,ac-wp7enmg-shard-00-01.gwcqbvw.mongodb.net:27017,ac-wp7enmg-shard-00-02.gwcqbvw.mongodb.net:27017/TicketPulse?ssl=true&replicaSet=atlas-tfx964-shard-0&authSource=admin&appName=BasesDatosCristian';

const schema = z.object({
  NODE_ENV: z.enum(['development', 'test', 'production']).default('development'),
  PORT: z.coerce.number().int().positive().default(process.env.PORT ? Number(process.env.PORT) : 5000),
  MONGODB_URI: z.string().default(process.env.MONGODB_URI || ATLAS_URI),
  FRONTEND_URL: z.string().default(process.env.FRONTEND_URL || 'https://ticket-pulse.vercel.app'),
...
export const config = parsed.success ? parsed.data : {
  ...
  MONGODB_URI: process.env.MONGODB_URI || ATLAS_URI,
  FRONTEND_URL: process.env.FRONTEND_URL || 'https://ticket-pulse.vercel.app',
